...
for(i=0; i<abrirmodal.length;i++){
    ...
    switch(modalid){
        case "modal1":
            ...
            imagenmodal.setAttribute("src", "imagenes/gato.jpg");
            imagenmodal.setAttribute("alt","Imagen 1");
            break;
            case "modal2":
                ventanamodal.classList.add(isvisible);
                imagenmodal.setAttribute("src", "imgagenes/Conejo sisasado de orejas lop.jpg");
                imagenmodal.setAttribute("alt","Imagen 2");
                break;
                case "modal3":
                    ventanamodal.classList.add(isvisible);
                    imagenmodal.setAttribute("src", "imgagenes/Chihuahua.jpg");
                    imagenmodal.setAttribute("alt","Imagen 3");
                    break;
                    case "modal4":
                        ventanamodal.classList.add(isvisible);
                        imagenmodal.setAttribute("src", "imgagenes/gatos persas .jpg");
